...
public class ArtistService
{
    ...
    {
        new Artist { Id = 1,  Name = "Andrius Mamontovas", Genre = "Rock",        Language = "Lietuvių",  ActiveFrom = 1989,                Country = "Lietuva"  },
        new Artist { Id = 2,  Name = "Skamp",              Genre = "Pop",         Language = "English",   ActiveFrom = 1999, ActiveTo = 2005, Country = "Lietuva"  },
        new Artist { Id = 3,  Name = "Jurga",              Genre = "Pop",         Language = "Lietuvių",  ActiveFrom = 2001,                Country = "Lietuva"  },
        ...
        new Artist { Id = 8,  Name = "Stromae",            Genre = "Electronic",  Language = "Prancūzų",  ActiveFrom = 2009,                Country = "Belgium"  },
        new Artist { Id = 9,  Name = "Rammstein",          Genre = "Metal",       Language = "Vokiečių",  ActiveFrom = 1994,                Country = "Germany"  },
        ...
        new Artist { Id = 13, Name = "G&G Sindikatas",     Genre = "Hip-Hop",     Language = "Lietuvių",  ActiveFrom = 1994,                Country = "Lietuva"  },
        new Artist { Id = 14, Name = "Sigur Rós",          Genre = "Post-Rock",   Language = "Islandų",   ActiveFrom = 1994,                Country = "Iceland"  },
        new Artist { Id = 15, Name = "Seu Jorge",          Genre = "MPB",         Language = "Portugalų", ActiveFrom = 1998,                Country = "Brazil"   },
    };
